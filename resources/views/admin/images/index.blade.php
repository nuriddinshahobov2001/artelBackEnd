                    ...
                    <tr>
                        ...
                        <td>
                            <a href="#" role="button" class="btn btn-primary"
                               data-bs-toggle="modal" data-bs-target="#editImage{{ $image->id }}"><i
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalLabel">Изменение изображений</h5>
                                    ...
                                    <form action="{{ route('image.update', $image->id) }}" method="POST"
                                        ...
                                        <select name="good_id" class="form-control" id="">
                                            @foreach($goods as $good)
                                                <option
                                                    value="{{ $good->id }}" {{ $image->good_id === $good->id ? 'selected' : '' }}>{{ $good->name }}</option>
                                            @endforeach
                                        </select>
