...
@section('content')
    <section>
        ...
        @endif
        <div>
            <a href="" class="btn btn-outline-primary" data-bs-toggle="modal" data-bs-target="#addBanner"
            >Добавить</a>
            <table class="table">
                <thead>
                <th>#</th>
    ...
    <div class="modal fade" id="addBanner" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{ route('sliders_and_banners.add_banner') }}" method="POST"
                    ...
                    <div class="modal-body">
                        ...
                        <div>
                            ...
                            <select name="type" id="" class="form-select">
                                <option value="2">Акционные</option>
                                <option value="3">Хит продаж</option>
                                <option value="4">Сезонные</option>
                            </select>
                        </div>
                    </div>
